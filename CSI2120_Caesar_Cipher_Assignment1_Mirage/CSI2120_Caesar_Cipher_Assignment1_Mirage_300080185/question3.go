...
func main() {
	...
	go CaesarCipherList(messages[:3], 2, ch)  // process first 1/3 of messages
	go CaesarCipherList(messages[3:6], 2, ch) // process second 1/3 of messages
	go CaesarCipherList(messages[6:9], 2, ch) // process last 1/3 of messages
